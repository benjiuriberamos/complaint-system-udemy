...
<head>
    ...
    <meta name="_token" value="{{ crsf_token() }}">
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper-->
    <div class="app-wrapper"> <!--begin::Header-->
        ...
        @include('layouts.adminlte-nav', ['globals' => $globals])
        @include('layouts.adminlte-aside', ['globals' => $globals])
        <main class="app-main"> <!--begin::App Content Header-->
            @yield('content')
        </main> <!--end::App Main--> <!--begin::Footer-->
        @include('layouts.adminlte-footer', ['globals' => $globals])
